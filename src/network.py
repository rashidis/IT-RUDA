...
class ResNetFc(nn.Module):
    def __init__(self, resnet_name, use_bottleneck=True, bottleneck_dim=10, new_cls=False, class_num=1000):
...
class LeNet(nn.Module):
    def __init__(self):
        ...
        self.middle=nn.Linear(500,250)
        self.classifier = nn.Linear(250, 10)
